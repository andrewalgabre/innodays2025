import{a as W}from"./chunk-YVLH6ENZ.js";import{a as $}from"./chunk-V3EMBTZ5.js";import{a as q}from"./chunk-UJRVMH5Z.js";import{N as G,O as Z,b as L,c as V,d as H,e as N,h as j,k as U}from"./chunk-OLYYRW65.js";import{$ as h,$a as f,Fa as w,Ja as F,Oa as p,R as O,Ua as c,V as S,Va as s,Wa as i,Xa as u,_a as x,aa as v,ab as d,f as b,gb as D,hb as P,ib as l,jb as _,kb as y,lb as R,qb as B,rb as K,t as I,ua as E,va as a}from"./chunk-NXH6DGID.js";var M={production:!1,anthropicApiKey:"ENC_BF0dyBVO1pULBVlUKNjZL1CMuV3Qr9EeXllRYhXW1tkczM3ciVWbtQkVzg1QF52c0RVe6pkaohFdnVVWG9mb1B3dyBlT0NlVNVjY4Q3cGVVMzhmUXllMR1mVSRWUzpULzATawFWL05WYts2c",geminiApiKey:"ENC_=EVQlBjRaFGaZtkR0BzdJhnQwEVZxNHOVRnSoplZ0A3N2JTL110bLZmYB9kS24kU4IWQuEVQ",geminiProjectId:"prj-bison-3097627891-rindern",geminiLocation:"us-central1"};var k=class{static encode(n){return`ENC_${btoa(n).split("").reverse().join("")}`}static decode(n){if(!n||!n.startsWith("ENC_"))return n;try{let o=n.substring(4).split("").reverse().join("");return atob(o)}catch(e){return console.error("Failed to decode secret:",e),""}}static encodeForEnvironment(n){return this.encode(n)}};var z=class t{constructor(n,e){this.http=n;this.settingsService=e}geminiApiKey=k.decode(M.geminiApiKey);projectId=M.geminiProjectId;location=M.geminiLocation;anthropicApiKey=k.decode(M.anthropicApiKey);anthropicModel="claude-sonnet-4-5-20250929";anthropicVersion="2023-06-01";analyze(n,e){return b(this,null,function*(){let o=this.settingsService.getProvider();return console.log("AI Analysis Service - analyze() called with provider:",o),console.log("Image blob size:",n.size,"type:",n.type),o==="anthropic"?yield this.analyzeWithAnthropic(n):yield this.analyzeWithGemini(n)})}analyzeWithAnthropic(n){return b(this,null,function*(){console.log("Using Anthropic Claude Sonnet 4.5...");try{let e=yield this.blobToBase64(n),o="https://api.anthropic.com/v1/messages",m=this.buildSystemPrompt(),r=this.buildUserPrompt(),g={model:this.anthropicModel,max_tokens:4096,system:[{type:"text",text:m,cache_control:{type:"ephemeral"}}],messages:[{role:"user",content:[{type:"image",source:{type:"base64",media_type:n.type||"image/jpeg",data:e}},{type:"text",text:r}]}]};console.log("Anthropic API key:",this.anthropicApiKey),console.log("Gemini API key:",this.geminiApiKey),console.log("Project ID:",this.projectId),console.log("Location:",this.location);let C={"x-api-key":this.anthropicApiKey,"anthropic-version":this.anthropicVersion,"content-type":"application/json","anthropic-dangerous-direct-browser-access":"true"};console.log("Making HTTP request to Anthropic...");let A=yield I(this.http.post(o,g,{headers:C}));return console.log("Anthropic response received:",A),this.parseAnthropicResponse(A)}catch(e){console.error("Anthropic analysis error:",e);let o="Anthropic API Fehler";throw e.status===401?o="Ung\xFCltiger Anthropic API-Key. Bitte in den Einstellungen pr\xFCfen.":e.status===429?o="Anthropic Rate Limit erreicht. Bitte sp\xE4ter erneut versuchen.":e.error?.error?.message?o=`Anthropic: ${e.error.error.message}`:e.message&&(o=`Anthropic: ${e.message}`),new Error(o)}})}analyzeWithGemini(n){return b(this,null,function*(){console.log("Using Google Gemini 2.5 Pro...");try{let e=yield this.blobToBase64(n),o=`https://${this.location}-aiplatform.googleapis.com/v1/projects/${this.projectId}/locations/${this.location}/publishers/google/models/gemini-2.5-pro:generateContent?key=${this.geminiApiKey}`,r={contents:[{role:"user",parts:[{text:this.buildPrompt()},{inline_data:{mime_type:n.type||"image/jpeg",data:e}}]}],generationConfig:{temperature:.2,topP:.8,topK:40,maxOutputTokens:4096}};console.log("Making HTTP request to Gemini...");let g=yield I(this.http.post(o,r));return console.log("Gemini response received:",g),this.parseGeminiResponse(g)}catch(e){console.error("Gemini analysis error:",e);let o="Gemini API Fehler";throw e.status===401||e.status===403?o="Ung\xFCltiger Gemini API-Key oder keine Berechtigung.":e.status===429?o="Gemini Rate Limit erreicht. Bitte sp\xE4ter erneut versuchen.":e.error?.error?.message?o=`Gemini: ${e.error.error.message}`:e.message&&(o=`Gemini: ${e.message}`),new Error(o)}})}buildSystemPrompt(){return`Du bist ein Experte f\xFCr Klauengesundheit und Infrarotdiagnostik bei Rindern mit jahrelanger Erfahrung in der Analyse von FLIR-Thermalbildern.
